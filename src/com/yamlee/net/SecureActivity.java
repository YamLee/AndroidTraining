...
/**
 * 加密方法介绍 1、MD5（message digest algorithm）不可逆加密 2、SHA(secure hash algorithm)
 * 不可逆加密 3、HMAC(hash message authentic code) 不可逆 4、AES 可逆的加密方法
 * 
 * @author Liyan
 * 
 */
public class SecureActivity extends Activity {
	...
	public void on_click(View v) {
		...
		if (TextUtils.isEmpty(et_secure_input.getText())) {
			Toast.makeText(this, "加密内容为空！", Toast.LENGTH_SHORT).show();
			return;
		} else {
